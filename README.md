...
- [给维护者](#maintainers) · 5% 读者
- [v1 不做的事](#out-of-scope)
- [反馈 & 贡献](#feedback)
...
1. **导出 Feishu 凭据到 shell rc** — 见 [Feishu 凭据](#feishu)。
...
> **没有 FoodMax-specific slash 命令** — repo 里 `commands/` 和 `agents/` 目录目前都不存在。想加 → 见 [加新 skill](#add-skill)。
